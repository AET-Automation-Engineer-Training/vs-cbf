...
#include "nav2_mppi_sacbf_controller/tools/utils.hpp"
#include "nav2_mppi_sacbf_controller/motion_models.hpp"
#include "nav2_mppi_sacbf_controller/critics/constraint_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/goal_angle_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/goal_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/obstacles_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/cost_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/path_align_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/path_align_legacy_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/path_angle_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/path_follow_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/prefer_forward_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/twirling_critic.hpp"
#include "nav2_mppi_sacbf_controller/critics/velocity_deadband_critic.hpp"
...
using namespace mppi_sacbf;  // NOLINT
using namespace mppi_sacbf::critics;  // NOLINT
using namespace mppi_sacbf::utils;  // NOLINT
...
TEST(CriticTests, ConstraintsCritic)
{
  ...
  critic.on_configure(node, "mppi_sacbf", "critic", costmap_ros, &param_handler);
