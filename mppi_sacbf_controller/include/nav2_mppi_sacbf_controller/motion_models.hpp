...
#ifndef NAV2_mppi_sacbf_CONTROLLER__MOTION_MODELS_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__MOTION_MODELS_HPP_

#include <cstdint>

#include "nav2_mppi_sacbf_controller/models/control_sequence.hpp"
...
public:
  /**
    * @brief Constructor for mppi_sacbf::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for mppi_sacbf::MotionModel
    */
...
/**
 * @class mppi_sacbf::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for mppi_sacbf::AckermannMotionModel
    */
...
/**
 * @class mppi_sacbf::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for mppi_sacbf::DiffDriveMotionModel
    */
...
/**
 * @class mppi_sacbf::OmniMotionModel
...
public:
  /**
    * @brief Constructor for mppi_sacbf::OmniMotionModel
    */
...
#endif  // NAV2_mppi_sacbf_CONTROLLER__MOTION_MODELS_HPP_
