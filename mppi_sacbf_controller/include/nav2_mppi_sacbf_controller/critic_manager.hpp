...
#ifndef NAV2_mppi_sacbf_CONTROLLER__CRITIC_MANAGER_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__CRITIC_MANAGER_HPP_
...
#include "nav2_mppi_sacbf_controller/critic_data.hpp"
...
/**
 * @class mppi_sacbf::CriticManager
...
public:
  /**
    * @brief Constructor for mppi_sacbf::CriticManager
    */
  CriticManager() = default;
  
  /**
    * @brief Virtual Destructor for mppi_sacbf::CriticManager
    */
...
#endif  // NAV2_mppi_sacbf_CONTROLLER__CRITIC_MANAGER_HPP_
