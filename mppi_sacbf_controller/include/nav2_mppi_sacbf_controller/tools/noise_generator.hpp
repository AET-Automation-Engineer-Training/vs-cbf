...
#ifndef NAV2_mppi_sacbf_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
...
/**
 * @class mppi_sacbf::NoiseGenerator
...
public:
  /**
    * @brief Constructor for mppi_sacbf::NoiseGenerator
    */
   ...
   */
  void initialize(
    mppi_sacbf::models::OptimizerSettings & settings,
   ...
   * @param is_holonomic If base is holonomic
   */
  void reset(mppi_sacbf::models::OptimizerSettings & settings, bool is_holonomic);
...
protected:
  ...
  mppi_sacbf::models::OptimizerSettings settings_;
  bool is_holonomic_;
...
#endif  // NAV2_mppi_sacbf_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
