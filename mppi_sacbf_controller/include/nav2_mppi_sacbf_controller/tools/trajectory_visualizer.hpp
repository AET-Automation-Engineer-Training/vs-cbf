...
#ifndef NAV2_mppi_sacbf_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
...
/**
 * @class mppi_sacbf::TrajectoryVisualizer
...
public:
  /**
    * @brief Constructor for mppi_sacbf::TrajectoryVisualizer
    */
...
protected:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("mppi_sacbfController")};
};

}  // namespace mppi_sacbf

#endif  // NAV2_mppi_sacbf_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
