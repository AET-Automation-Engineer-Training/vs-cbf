...
#ifndef NAV2_mppi_sacbf_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  /**
    * @brief Constructor for mppi_sacbf::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for mppi_sacbf::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // NAV2_mppi_sacbf_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
