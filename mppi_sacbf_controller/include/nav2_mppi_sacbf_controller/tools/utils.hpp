...
#ifndef NAV2_mppi_sacbf_CONTROLLER__TOOLS__UTILS_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__TOOLS__UTILS_HPP_
...
inline void savitskyGolayFilter(
  ...
  std::array<mppi_sacbf::models::Control, 4> & control_history,
...
#endif  // NAV2_mppi_sacbf_CONTROLLER__TOOLS__UTILS_HPP_
