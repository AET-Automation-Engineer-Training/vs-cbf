...
#ifndef NAV2_mppi_sacbf_CONTROLLER__OPTIMIZER_HPP_
#define NAV2_mppi_sacbf_CONTROLLER__OPTIMIZER_HPP_
...
#include "nav2_mppi_sacbf_controller/models/optimizer_settings.hpp"
#include "nav2_mppi_sacbf_controller/motion_models.hpp"
#include "nav2_mppi_sacbf_controller/critic_manager.hpp"
#include "nav2_mppi_sacbf_controller/models/state.hpp"
#include "nav2_mppi_sacbf_controller/models/trajectories.hpp"
#include "nav2_mppi_sacbf_controller/models/path.hpp"
#include "nav2_mppi_sacbf_controller/tools/noise_generator.hpp"
#include "nav2_mppi_sacbf_controller/tools/parameters_handler.hpp"
#include "nav2_mppi_sacbf_controller/tools/utils.hpp"

namespace mppi_sacbf
{

/**
 * @class mppi_sacbf::Optimizer
 * @brief Main algorithm optimizer of the mppi_sacbf Controller
 */
class Optimizer
{
public:
  /**
    * @brief Constructor for mppi_sacbf::Optimizer
    */
  Optimizer() = default;

  /**
   * @brief Destructor for mppi_sacbf::Optimizer
   */
  ~Optimizer() {shutdown();}
  ...
  /**
   * @brief Compute control using mppi_sacbf algorithm
   ...
   * @return TwistStamped of the mppi_sacbf control
   */
...
protected:
  ...
  std::array<mppi_sacbf::models::Control, 4> control_history_;
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("MPPISACBFController")};
};

}  // namespace mppi_sacbf

#endif  // NAV2_mppi_sacbf_CONTROLLER__OPTIMIZER_HPP_
