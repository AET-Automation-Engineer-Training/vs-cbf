...
void NoiseGenerator::initialize(
  mppi_sacbf::models::OptimizerSettings & settings, bool is_holonomic,
...
void NoiseGenerator::reset(mppi_sacbf::models::OptimizerSettings & settings, bool is_holonomic)
{
  settings_ = settings;
  is_holonomic_ = is_holonomic;
